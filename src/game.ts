...
const transform2 = new Transform({
  position: new Vector3(9.5, 1.5, 8),
...
const transform9 = new Transform({
  position: new Vector3(5.5, 2, 16),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
videoStream3.addComponentOrReplace(transform9)
...
videoStream4.addComponentOrReplace(transform10)
...
videoStream5.addComponentOrReplace(transform11)

const videoStream6 = new Entity('videoStream6')
engine.addEntity(videoStream6)
videoStream6.setParent(_scene)
const transform12 = new Transform({
  position: new Vector3(16, 2, 12.5),
  rotation: new Quaternion(-1.9455749640203465e-15, 0.7071068286895752, -8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(1.0000054836273193, 1, 1.0000054836273193)
})
videoStream6.addComponentOrReplace(transform12)

const videoStream7 = new Entity('videoStream7')
engine.addEntity(videoStream7)
videoStream7.setParent(_scene)
const transform13 = new Transform({
  position: new Vector3(0, 1.5, 5.5),
...
videoStream7.addComponentOrReplace(transform13)

const videoStream8 = new Entity('videoStream8')
engine.addEntity(videoStream8)
videoStream8.setParent(_scene)
const transform14 = new Transform({
  position: new Vector3(15, 1.5, 11),
  rotation: new Quaternion(4.731725943138074e-15, -0.70710688829422, 8.42937097900176e-8, 0.7071067690849304),
  scale: new Vector3(1.0000057220458984, 1, 1.0000057220458984)
})
videoStream8.addComponentOrReplace(transform14)

const videoStream9 = new Entity('videoStream9')
engine.addEntity(videoStream9)
videoStream9.setParent(_scene)
const transform15 = new Transform({
  position: new Vector3(12, 1.5, 0),
  rotation: new Quaternion(-3.768626188703885e-15, -1, 1.1920928955078125e-7, -1.1920927533992653e-7),
  scale: new Vector3(1.0000057220458984, 1, 1.0000057220458984)
})
videoStream9.addComponentOrReplace(transform15)
...
videoStream10.addComponentOrReplace(transform16)
...
videoStream11.addComponentOrReplace(transform17)
...
videoStream12.addComponentOrReplace(transform18)

const ambientSound = new Entity('ambientSound')
engine.addEntity(ambientSound)
ambientSound.setParent(_scene)
const transform19 = new Transform({
  position: new Vector3(0.5, 0, 9.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
ambientSound.addComponentOrReplace(transform19)
...
script1.spawn(videoStream6, {"startOn":"false","onClickText":"Play video","volume":1,"onClick":[{"entityName":"videoStream6","actionId":"toggle","values":{}}],"onActivate":[{"entityName":"videoStream6","actionId":"activate","values":{}}],"onDeactivate":[{"entityName":"videoStream6","actionId":"activate","values":{}}]}, createChannel(channelId, videoStream6, channelBus))
script1.spawn(videoStream7, {"startOn":"false","onClickText":"Play video","volume":1,"onClick":[{"entityName":"videoStream7","actionId":"toggle","values":{}}],"onActivate":[{"entityName":"videoStream7","actionId":"activate","values":{}}],"onDeactivate":[{"entityName":"videoStream7","actionId":"activate","values":{}}]}, createChannel(channelId, videoStream7, channelBus))
...
script1.spawn(videoStream9, {"startOn":"false","onClickText":"Play video","volume":1,"onClick":[{"entityName":"videoStream9","actionId":"toggle","values":{}}],"onActivate":[{"entityName":"videoStream9","actionId":"activate","values":{}}],"onDeactivate":[{"entityName":"videoStream9","actionId":"activate","values":{}}]}, createChannel(channelId, videoStream9, channelBus))
